     ...
     <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-sm p-6 mb-8">
       <div className="mb-4">
         ...
         <input
           ...
           className={`w-full p-2 border rounded text-gray-800 placeholder-gray-400 ${errors.title ? "border-red-500" : ""}`}
       ...
       <div className="mb-4">
         <div className="flex justify-between mb-1">
           ...
           <span className="text-sm text-gray-500">{content.length}/{MAX_CONTENT_LENGTH}</span>
         </div>
         <textarea
           value={content}
           onChange={(e) => {
           ...
           className={`w-full p-2 border rounded h-32 text-gray-800 placeholder-gray-400 ${errors.content ? "border-red-500" : ""}`}
           disabled={isSubmitting}
         />
         {errors.content && (
